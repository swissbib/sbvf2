 ...
 */
  ...
  $(document).ready(function() {
    ...
    if (field) {
      $(field).autocomplete(
      "nose/useraccount/favorites/favoritesServlet.jsp?type=library",
      {
    	  autoFill: false,
        initialFocus: false,
        minChars: 0,
    ...
    if (fieldIdentifier) {
        $(fieldIdentifier).autocomplete(
        "nose/useraccount/favorites/favoritesServlet.jsp?type=libraryIdentifier",
        {
        	autofill: false,
          initialFocus: false,
          minChars: 0,
    ...
    if (group) {
        $(group).autocomplete(
        "nose/useraccount/favorites/favoritesServlet.jsp?type=librarygroup",
        {
          autofill: false,
          initialFocus: true,
          minChars: 0,
