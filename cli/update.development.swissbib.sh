...
su -c "git stash" swissbib >> $LOG 2>&1
su -c "git checkout development" swissbib >> $LOG 2>&1
su -c "git pull origin development" swissbib >> $LOG 2>&1
su -c "git stash pop" swissbib >> $LOG 2>&1
