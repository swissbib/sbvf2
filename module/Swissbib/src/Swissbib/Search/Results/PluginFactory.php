...
/**
 * swissbib / VuFind enhancements for a factory responsible to create an extended results type for the Solr target
 * which itself depends on an extended params type for the SOLR target
 *
 * PHP version 5
 *
...
use VuFind\Search\Results\PluginFactory as VFResultsPluginFactory;
use Swissbib\Search\Helper\ExtendedSolrFactoryHelper;




class PluginFactory extends VFResultsPluginFactory {
